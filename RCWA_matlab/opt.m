...
x0 = [0.8, -2*Kz, 0.4, 1.4*Kz];
options = optimoptions('fmincon','Algorithm','interior-point','Display','iter');
% results in res
res = fmincon(@foo_optimization, x0, [], [], [], [], [0, 10*Kz, 0, 10*Kz], [1, -10*Kz, 1, -10*Kz], [], options);
...
DETr1 = [];
DETr2 = [];
lay1 = PVG2(wl0*res(1)/dn, Kx, res(2), -1, no, ne);
lay2 = PVG2(wl0*res(3)/dn, Kx, res(4), -1, no, ne);
lays = {lay1, lay2};
